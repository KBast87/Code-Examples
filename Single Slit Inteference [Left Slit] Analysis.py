...
f = B.get_file('Single Slit Interference [Left Slit].data')
...
#B.pl.title('Voltage [V] vs Position [mm] [Left Slit]')
...
fit = G.genfit(I, [D,I0,x0], x, y=Vn)
B.plot_exp(x,Vn,dVn)
B.plot_line(x,I(x))

B.pl.show()

B.pl.title('Relative Intensity [V] vs Viewing Angle [rad] [Left Slit]')
